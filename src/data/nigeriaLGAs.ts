/**
 * Full directory of Nigerian Local Government Areas by state (774 total).
 * Used to populate jurisdiction dashboards' province/LGA selectors.
 * Keys mirror the state names used during super admin onboarding.
 */
export const NIGERIA_LGAS: Record<string, string[]> = {
  Abia: [
    'Aba North', 'Aba South', 'Arochukwu', 'Bende', 'Isiala Ngwa North',
    'Isiala Ngwa South', 'Isuikwuato', 'Obi Ngwa', 'Osisioma Ngwa',
    'Ugwunagbo', 'Ukwa East', 'Ukwa West', 'Umuahia North', 'Umuahia South',
    'Umunneochi', 'Ikwuano', 'Ohafia',
  ],
  Adamawa: [
    'Demsa', 'Fufore', 'Ganye', 'Girei', 'Gombi', 'Guyuk', 'Hong', 'Jada',
    'Lamurde', 'Madagali', 'Maiha', 'Mayo-Belwa', 'Michika', 'Mubi North',
    'Mubi South', 'Numan', 'Shelleng', 'Song', 'Yola North', 'Yola South',
    'Toungo',
  ],
  'Akwa Ibom': [
    ...
    'Oron', 'Oruk Anam', 'Udung Uko', 'Ukanafun', 'Urue-Offong/Oruko',
    'Uruan', 'Uyo',
  ],
  Anambra: [
  ...
  Ebonyi: [
    'Abakaliki', 'Ebonyi', 'Ezza North', 'Ezza South', 'Ikwo', 'Ishielu',
    'Ivo', 'Izzi', 'Ohaozara', 'Ohaukwu', 'Onicha', 'Afikpo North',
    'Afikpo South',
  ],
  Edo: [
  ...
  Imo: [
    'Aboh Mbaise', 'Ahiazu Mbaise', 'Ehime Mbano', 'Ideato North',
  ...
  Kano: [
    ...
    'Gwarzo', 'Kabo', 'Kano Municipal', 'Karaye', 'Kibiya', 'Kiru', 'Kura',
    'Kunchi', 'Madobi', 'Makoda', 'Minjibir', 'Nasarawa', 'Rano',
  ...
  Katsina: [
    ...
    'Mani', 'Mashe', 'Matazu', 'Musawa', 'Rimi', 'Sabuwa', 'Safana',
    'Sandamu', 'Zango',
  ],
  Kebbi: [
    'Aleiro', 'Arewa Dandi', 'Argungu', 'Augie', 'Bagudo', 'Birnin Kebbi',
    'Bunza', 'Dandi', 'Danko Wasagu', 'Fakai', 'Gwandu', 'Jega', 'Kalgo',
    'Koko Besse', 'Maiyama', 'Ngaski', 'Sakaba', 'Shanga', 'Suru', 'Yauri',
    'Zuru',
  ],
  Kogi: [
  ...
  Osun: [
    ...
    'Ilesa East', 'Ilesa West', 'Irewole', 'Irepodun', 'Isokan', 'Iwo',
    'Obokun', 'Odo-Otin', 'Ola Oluwa', 'Olorunda', 'Oriade', 'Osogbo',
    'Orolu',
  ],
  Oyo: [
  ...
  Rivers: [
    'Port Harcourt', 'Obio/Akpor', 'Okrika', 'Ogu-Bolo', 'Tai', 'Gokana',
    'Khana', 'Eleme', 'Bonny', 'Degema', 'Asari-Toru', 'Akuku-Toru',
    'Andoni', 'Opobo/Nkoro', 'Etche', 'Omuma', 'Ahoada East', 'Ahoada West',
    'Abua/Odual', 'Ogba/Egbema/Ndoni', 'Emohua', 'Ikwerre', 'Oyigbo',
  ],
  Sokoto: [
